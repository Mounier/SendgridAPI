...
public class SendToV3CustomArgs {
	private String newArgument1;
	private String activationAttempt;
	private String customerAccountNumber;
	
	public SendToV3CustomArgs() {
		super();
		// TODO Auto-generated constructor stub
	}

	public SendToV3CustomArgs(String newArgument1, String activationAttempt, String customerAccountNumber) {
		super();
	...
	public String toString() {
		return "SendToV3CustomArgs [newArgument1=" + newArgument1 + ", activationAttempt=" + activationAttempt
